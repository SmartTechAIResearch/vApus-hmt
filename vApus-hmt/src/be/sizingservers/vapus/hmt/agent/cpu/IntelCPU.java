...
public class IntelCPU extends CPU {
    ...
    public Entities getWIWWithCounters(Entities wiw) throws Exception {
        ...
        ArrayList<Integer> updatedOldTimestampCtrs = new ArrayList<Integer>();
     ...
     */
    public float getCoreTemperature(int core) throws Exception {
     //	 Digital temperature reading in 1 degree
        ...
        return (float) (this.maxProcessorTemp - value);
    }
